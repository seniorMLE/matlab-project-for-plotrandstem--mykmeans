 generic function for random forests (checks out of bag errors).
The example loads sample data and 



function RETree = createRandomforest(Data,Labels,varargin)


okargs =   {'minparent' 'minleaf' 'nvartosample' 'method' 'weights'};
defaults = {2 1 size(Data,2) 'c' []}; %init variable 
[eid,emsg,minparent,minleaf,m,method,W] = getargs(okargs,defaults,varargin{:}); %get variable 
